...
#values ()
 ...
 /---------
INSERT INTO app.sys_param_list_value (id, created_on, description, display_name, interpretation, list_order, modified_on, tag, tag_id, value, modified_by) VALUES (508, CURRENT_TIMESTAMP, 'Type of report. Internal to system', 'Type Flag', 'Till Date', 0, CURRENT_TIMESTAMP, 'Type_Flag', null, '1', null);
INSERT INTO app.sys_param_list_value (id, created_on, description, display_name, interpretation, list_order, modified_on, tag, tag_id, value, modified_by) VALUES (509, CURRENT_TIMESTAMP, 'Type of report. Internal to system', 'Type Flag', 'Daily', 1, CURRENT_TIMESTAMP, 'Type_Flag', null, '2', null);
INSERT INTO app.sys_param_list_value (id, created_on, description, display_name, interpretation, list_order, modified_on, tag, tag_id, value, modified_by) VALUES (510, CURRENT_TIMESTAMP, 'Type of report. Internal to system', 'Type Flag', 'Monthly', 2, CURRENT_TIMESTAMP, 'Type_Flag', null, '3', null);
INSERT INTO app.sys_param_list_value (id, created_on, description, display_name, interpretation, list_order, modified_on, tag, tag_id, value, modified_by) VALUES (511, CURRENT_TIMESTAMP, 'Type of report. Internal to system', 'Type Flag', 'Yearly', 3, CURRENT_TIMESTAMP, 'Type_Flag', null, '4', null);
INSERT INTO app.sys_param_list_value (id, created_on, description, display_name, interpretation, list_order, modified_on, tag, tag_id, value, modified_by) VALUES (801, CURRENT_TIMESTAMP, 'Type of report. Internal to sy', 'Type Flag', 'NA', 4, CURRENT_TIMESTAMP, 'Type_Flag', null, '0', null);
