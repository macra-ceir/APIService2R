...
//
//
//            query = getSelectString(reportDb, columns, reportTrend);
//
...
//    }
//
//    private static String getSelectString(ReportDb reportDb, String columns, String reportTrend) {
//        String query;
...
//            {   //where Block
//                if (Objects.nonNull(filterRequest.getStartDate()) && !filterRequest.getStartDate().equals("")) {
//                    where = where + " CREATED_ON >= TO_DATE('" + filterRequest.getStartDate() + "', 'YYYY-MM-DD') and";                //  startDate = "'" + filterRequest.getStartDate() + "'";//  where = where + " DATE(created_on) >= DATE('" + filterRequest.getStartDate() + "') and";
//                }
//                if (Objects.nonNull(filterRequest.getEndDate()) && !filterRequest.getEndDate().equals("")) {
//                    where = where + " CREATED_ON <= TO_DATE('" + filterRequest.getEndDate() + "', 'YYYY-MM-DD') and";                   //  endDate = "'" + filterRequest.getEndDate() + "'";//  where = where + " DATE(created_on) >= DATE('" + filterRequest.getEndDate() + "') and";
//                }
//                reportDb = columnDetails.get(0).getReport();
//                if (filterRequest.isLastDate()) {
//                    if (Objects.nonNull(reportTrend) && reportTrend.equalsIgnoreCase("monthly"))
